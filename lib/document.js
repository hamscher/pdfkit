...
import StructTreeRootMixin from './mixins/struct_tree_root';
...
class PDFDocument extends stream.Readable {
  constructor(options = {}) {
    ...
    if (this.options.DisplayDocTitle) {
      this._root.data.ViewerPreferences = {
        DisplayDocTitle: this.options.DisplayDocTitle
      };
    }
